const NewHeader = () => {
  return (
    <nav
      x-data="{ isOpen: false }"
      className="bg-white shadow dark:bg-gray-800 farsi-text"
    >
              ...
              <nav>
                <ul className="flex items-center justify-center font-semibold">
                  ...
                  {/* <li className="px-3 py-2 relative group">
                    ...
                    <div className="absolute lg:-left-24 top-3 transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 ease-in-out group-hover:transform z-50 min-w-[560px] transform">
                      <div className="relative top-6 p-6 bg-white rounded-xl shadow-xl w-full">
                        ...
                        <div className="relative z-10">
                          ...
                          <div className="grid grid-cols-2 gap-6 mt-6">
                            <div>
                              <p className="uppercase tracking-wider text-gray-500 text-[13px]">
                                Get started
                              </p>
                              <ul className="mt-3 text-[15px]">
                                <li>
